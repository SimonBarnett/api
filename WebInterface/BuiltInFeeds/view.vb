        ...
        Overrides Sub ProcessReq(ByVal context As HttpContext)
            ...
            With context.Response
                ...
                With objX
                    ...
                    .WriteAttributeString("tabulaini", WebConfigurationManager.AppSettings("tabulaini"))
                    .WriteAttributeString("version", Assembly.GetExecutingAssembly.GetName.Version.ToString)
