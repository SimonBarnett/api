...
<ExportMetadata("EndPoint", "testtemplfeed")>
<ExportMetadata("Hidden", False)>
Public Class testtemplfeed : Inherits iFeed : Implements xmlFeed
    ...
    ''' </summary>
    ''' <returns>The install QSL for this testtemplfeed</returns>
