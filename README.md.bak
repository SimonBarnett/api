...
Project managers can build new end-points using the .net templates provided and deploy them by simply by copying an edited template to the /bin folder of the API.
...
<l1>Handler end-points receive data from a third party. 
<l1>The end-point builds a loading 
<l1>The loading is processed by the <a href="https://github.com/SimonBarnett/apiLoad">nodeJS loading service</a>.
